...
for zdim in 2
do
for frequency_of_latent_change in 0 1 5 10 20 50
do
name="exp=${exp}_global_res=${nat_resampling}_train_size=${train_size}_folc=${frequency_of_latent_change}_rec_lambda=${rec_lambda}_zdim=${zdim}_sinkhorn_epsilon=${sinkhorn_epsilon}_ot_lambda=${ot_lambda}_${dt}"
python run.py \
    ...
    --frequency_of_latent_change=${frequency_of_latent_change} \
